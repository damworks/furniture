jQuery(function() {
   ...
   jQuery('.home-content .products-grid li.item').hover(
		function(){
			jQuery('.btn-cart', this).css({opacity:1}).show();
			jQuery('.btn-cart', this).animate({opacity:1, bottom: '+=10'}, 400);		
		},
		function(){
			jQuery('.btn-cart', this).animate({opacity:0, bottom: '-=10'}, 400);
		})
	// product box hover
   jQuery('.home-content .products-grid li.item').hover(
		function(){
			jQuery('.socialToolBar', this).animate({opacity:0.6, top: '-=10'}, 400);
			jQuery('.ShowTool', this).animate({opacity:1, top: '-=8'}, 400);			
		},
		function(){
			jQuery('.socialToolBar', this).animate({opacity:0, top: '+=10'}, 400);
			jQuery('.ShowTool', this).animate({opacity:0, top: '+=8'}, 400);
		})	
	// circle box hover
